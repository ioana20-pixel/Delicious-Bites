...
if (isset($_POST['add_to_favourites'])) {
    ...
    $recipe_id = 5;  // Recipe ID, ensure this matches with your database structure
    ...
    <main>
        <section class="recipe-detail">
            ...
            <ol>
                ...
                <li>Mash the avocado with a fork and mix in a squeeze of lemon juice.</li>
                <li>Spread the mashed avocado on the toasted bread.</li>
                <li>Season with salt, pepper, and chili flakes. Serve immediately.</li>
            </ol>
        </section>
