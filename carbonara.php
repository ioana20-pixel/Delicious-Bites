...
if (isset($_POST['add_to_favourites'])) {
    ...
    $recipe_id = 4;  // Recipe ID, ensure this matches with your database structure
    ...
    <main>
        <section class="recipe-detail">
            ...
            <ol>
                ...
                <li>Whisk eggs with parmesan, salt, and pepper.</li>
                <li>Mix everything together with a bit of pasta water to create a creamy sauce. Serve immediately.</li>
            </ol>
        </section>
